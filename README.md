...
```
dream models deploy model_example_y v8
```
...
```
git clone --branch v8 --single-branch git@github.com:dreamutherland/model_example_y.git
...
```
docker run -d -p PORT:PORT jleighsutherland/model_example_y:v8
```
